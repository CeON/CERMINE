 ...
 *
 */
public class ContentExtractorWithTimeout {
    ...
    public ContentExtractorWithTimeout() throws AnalysisException{
    ...
    public static void main(String[] args) throws ParseException, AnalysisException, IOException, TransformationException {
        ...
        if (file.isFile()) {
            try {
                ContentExtractorWithTimeout extractor = 
                        new ContentExtractorWithTimeout();
            ...
            for (File pdf : files) {
                ...
                ContentExtractorWithTimeout extractor = null;
                try {
                    extractor = new ContentExtractorWithTimeout();
                    if (timeoutSeconds != null){
                        extractor.setTimeout(timeoutSeconds);
                    }
                    parser.updateMetadataModel(extractor.getConf());
