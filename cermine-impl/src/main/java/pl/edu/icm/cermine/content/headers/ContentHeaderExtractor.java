 ...
 */
public abstract class ContentHeaderExtractor {
    ...
    protected abstract boolean isHeader(BxLine line, BxPage page);
        
    public BxDocContentStructure extractHeaders(FeatureVectorBuilder<BxLine, BxPage> clustVectorBuilder,
