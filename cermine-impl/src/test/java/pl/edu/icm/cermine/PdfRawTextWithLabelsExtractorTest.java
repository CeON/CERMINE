 ...
 */
public class PdfRawTextWithLabelsExtractorTest {
    static final private String TEST_FILE = "/pl/edu/icm/cermine/test2.pdf";
    static final private String EXP_FILE = "/pl/edu/icm/cermine/test2-raw_with_labels.xml";
    
    private PdfRawTextWithLabelsExtractor extractor;
    
    @Before
    public void setUp() throws AnalysisException, IOException {
        extractor = new PdfRawTextWithLabelsExtractor();
    }
    ...
    public void contentExtractionTest() throws AnalysisException, JDOMException, IOException, SAXException {
        ...
        Element testContent;
        try {
            testContent = extractor.extractRawText(testStream);
        } finally {
            testStream.close();
        }
