 ...
 */
public class BwmetaToDocumentReader implements FormatToModelReader<Document> {
    ...
    public Document read(Reader reader, Object... hints) throws TransformationException {
        try {
            ...
            document.setContent(new ContentStructure());
            
            XPath xpath = XPath.newInstance(".//x:relation[@type='reference-to']/x:attribute[@key='reference-text']/x:value");
