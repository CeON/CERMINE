...
public class ClusteringBibReferenceExtractorTest {
    static final private String TEST_FILE = "/pl/edu/icm/coansys/metaextr/bibref/refs.xml.zip";
    static final private String EXP_FILE = "/pl/edu/icm/coansys/metaextr/bibref/refs.txt";
