...
import pl.edu.icm.coansys.metaextr.content.LogicalStructureExtractor;
...
public class SimpleLogicalStructureExtractorTest {
    ...
    public void setUp() throws IOException, TransformationException, AnalysisException, URISyntaxException, JDOMException {
        ...
        junkVectorBuilder.setFeatureCalculators(Arrays.<FeatureCalculator<BxZone, BxPage>>asList(
                new pl.edu.icm.coansys.metaextr.content.features.zone.AreaFeature(),
                new pl.edu.icm.coansys.metaextr.content.features.zone.FigureTableFeature(),
                new pl.edu.icm.coansys.metaextr.content.features.zone.GreekLettersFeature(),
                new pl.edu.icm.coansys.metaextr.content.features.zone.RelativeMeanLengthFeature(),
                new pl.edu.icm.coansys.metaextr.content.features.zone.MathSymbolsFeature(),
                new pl.edu.icm.coansys.metaextr.content.features.zone.XVarianceFeature()
                ));
