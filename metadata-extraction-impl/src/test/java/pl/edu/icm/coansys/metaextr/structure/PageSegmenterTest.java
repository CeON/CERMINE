...
import pl.edu.icm.coansys.metaextr.structure.XYCutPageSegmenter;
...
import pl.edu.icm.coansys.metaextr.structure.tools.UnsegmentedZonesFlattener;
...
public class PageSegmenterTest extends AbstractDocumentProcessorTest {
    ...
    protected static String[] testResources = {"/pl/edu/icm/coansys/metaextr/structure/001.xml"};
    protected static String[] zipResources = {"/pl/edu/icm/coansys/metaextr/structure/margSmallSample.zip"};
