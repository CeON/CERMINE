...
public class LogicalStructureExtractorDemo {
    ...
    public void setUp() throws IOException, TransformationException, AnalysisException, URISyntaxException, JDOMException {
        ...
        junkVectorBuilder.setFeatureCalculators(Arrays.<FeatureCalculator<BxZone, BxPage>>asList(
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.AreaFeature(),
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.FigureTableFeature(),
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.GreekLettersFeature(),
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.RelativeMeanLengthFeature(),
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.MathSymbolsFeature(),
                new pl.edu.icm.yadda.analysis.articlecontent.features.zone.XVarianceFeature()
                ));
