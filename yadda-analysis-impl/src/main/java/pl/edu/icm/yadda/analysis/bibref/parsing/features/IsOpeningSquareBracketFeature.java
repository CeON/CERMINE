 ...
 */
public class IsOpeningSquareBracketFeature implements FeatureCalculator<CitationToken, Citation> {

    private static String featureName = "IsOpeningSquareBracket";
