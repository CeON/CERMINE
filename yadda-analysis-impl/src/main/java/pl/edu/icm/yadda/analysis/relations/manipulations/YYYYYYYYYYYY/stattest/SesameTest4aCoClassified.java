...
public class SesameTest4aCoClassified extends SesameBasicOperations{

	public static void main(String[] args) throws Exception {
		new SesameTest4aCoClassified().execute();
	}
	
	public void test() {
		try {
			System.out.println("======================================================");
			System.out.println("CO-CLASSIFIED-MSC ");
			System.out.println("======================================================");
			...
			for(Map.Entry<String, Set<String>> e : hm.entrySet()){
				...
				for(int i=0;i<arr.length;i++){
					...
					for(int j=i+1;j<arr.length;j++){
					    ...
					    "				{doc2} <"+RelConstants.RL_HAS_CONTRIBUTOR+"> {msc}," +	    
					    "           WHERE " +
					    "			doc1 != doc2	" +
						"";
