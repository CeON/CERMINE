...
public class SesameTest7aCoISSN extends SesameBasicOperations{

	public static void main(String[] args) throws Exception {
		new SesameTest7aCoISSN().execute();
	}
	...
	public void test() {
		try {
			...
			System.out.println("All contribs with same co-issn: "+totalNumbr);
