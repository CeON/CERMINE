...
public class SesameTest8aCoISBN extends SesameBasicOperations{
	public static void main(String[] args) throws Exception {
		new SesameTest8aCoISBN().execute();
	}
	
	public void test() {
		try {
			System.out.println("======================================================");
			System.out.println("CO-ISBN ");
			System.out.println("======================================================");
			...
			System.out.println("All contribs with same co-isbn: "+totalNumbr);
