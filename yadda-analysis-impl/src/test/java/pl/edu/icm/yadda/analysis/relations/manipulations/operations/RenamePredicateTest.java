...
//		rnp_m =  new SesameManipulator(repository, new RenamePrediacate());
//	}
//
//	/**
//	 * @throws java.lang.Exception
...
//			
//			hm = new HashMap<String,Object>();
//			hm.put("oldRelationName", RelConstants.RL_IS_PERSON);
//			hm.put("newRelationName", "http://hubert");
//			rnp_m.execute(hm);
//			
//			hm = new HashMap<String,Object>();
//			hm.put("isPersonPredicate", "http://hubert");
//			atsi_m.execute(hm);
//			
//			String contribQuery = "" +
//			  "Select distinct c,i,same,c1,c2,p1,p2  \n" +
