...
//
//public class WeightRecalculationTest {
//
...
//						vf.createURI(RelConstants.RL_OBSERVATION_CONTAINS_SAME_PERSON+"#f1"),
...
//						(Resource)null);
//				
////				double midVal = clue.analyze(bs.getValue("c1").stringValue(), 
////						bs.getValue("c2").stringValue());
////				
////				repository.getConnection().add(vf.createURI(bs.getValue("c").stringValue()), 
////						vf.createURI(RelConstants.RL_OBSERVATION_CONTAINS_SAME_PERSON+"#f1"),
////						vf.createLiteral( midVal+""),  
////						(Resource)null);
//				
//			}
//			
